...
CONAN_IMAGE_PATH = os.path.join(ORIGINAL_TAVERN_DIR_PATH, "conan.png")
ELF_IMAGE_PATH = os.path.join(ORIGINAL_TAVERN_DIR_PATH, "elf.png")
...
# ------
FIRST_QUEST = new_quest("first-quest", FIRST_QUEST_IMAGE_PATH, new_dimensions(349, 407, 533, 485), new_location(444, 448))
SECOND_QUEST = new_quest("second-quest", SECOND_QUEST_IMAGE_PATH, new_dimensions(581, 407, 777, 485), new_location(680, 448))
THIRD_QUEST = new_quest("third-quest", THIRD_QUEST_IMAGE_PATH, new_dimensions(819, 407, 1010, 485), new_location(911, 448))
